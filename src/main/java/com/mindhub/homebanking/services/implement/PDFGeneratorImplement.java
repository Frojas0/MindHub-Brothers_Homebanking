...
//        Logo
        Image img = Image.getInstance("src/main/resources/static/web/assets/images/logo03BG.png");
...
//        Title
        Paragraph title = new Paragraph("Transactions History", fontTitle);
        title.setAlignment(Element.ALIGN_CENTER);
        title.setSpacingAfter(10);
        document.add(title);

        Paragraph paragraph = new Paragraph("Hello " + account.getClient().getFirstName() + " here are the transactions history of your account: " + account.getNumber());
